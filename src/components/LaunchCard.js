            ...
            <CardContent style={{backgroundColor: "#232323", padding:"10px"}}>
                <Grid>
                    <Grid  marginBottom="10px" display="flex">
                        ...
                        <MHidden width="mdUp">
                        <Box bgcolor={"#232323"} borderRadius={0.5} width="60px" fontSize={14} padding="5px 10px 5px 10px" position="absolute" left="20px" top="15px">Public</Box>
                        <Box bgcolor={"#232323"} borderRadius={0.5} width="60px" display="flex" justifyContent="center" fontSize={14} padding="5px 10px 5px 10px" position="absolute" right="20px" top="15px">NFT</Box>
                        </MHidden>
                    </Grid>
                    <Grid>
