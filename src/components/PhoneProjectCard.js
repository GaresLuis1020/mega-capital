...
export default function PhoneProjectCard(props){
    ...
    return(
        ...
        <Grid container borderRadius={1} direction="row" bgcolor={"#232323"} padding="15px" marginTop="20px" display="flex" >
            ...
            <Grid item container xs={4} align="center" justifyContent="center" spacing={1} direction="column" paddingLeft="10px">
            ...
            <Grid item container xs={4} align="center" justifyContent="center">
                <Grid item><Box color="#56C5FF">CLAIMABLE</Box></Grid>
            </Grid>
            {cur_dir === "up" ? <>
            <Grid iem xs={2} padding="20px 0px 0px 20px">
            ...
            <Grid iem xs={2} padding="20px 0px 0px 20px">
                <Box component="button" onClick={() => setDirection("up")} backgroundColor="rgb(255,255,255,0)" border="none">
                    <Box component="img" src="my_public/images/angle_down.png"></Box>
                </Box>
            </Grid>
            }
        </Grid>
