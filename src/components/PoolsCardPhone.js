        ...
        <Grid container spacing={2}>
            <Grid item xs = {4.5}>
              <Box sx={{ display: 'flex', flexDirection: 'row', }}>
                ...
                <Box component="a" href="/stakepad" padding="2px" borderRadius={0.5} style={{textDecoration:"none", fontSize:12, border:"none", width:"50px", height:"50%", marginTop:"15px", color: 'white', backgroundColor:'#56C5FF'}}>Discover</Box>
              </Box>
            </Grid>
            <Grid item xs={3.5}>
