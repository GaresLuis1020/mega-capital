  ...
  return (
    ...
    <MHidden width="mdDown">
      {account ? (
        ...
        <Box component="button" height="40px" color="white" backgroundColor="#56C5FF" padding="5px 14px" border="none" borderRadius={0.5} onClick={onPresentConnectModal} >
          Connect Wallet
        </Box>
      )}
    </MHidden>
    <MHidden width="mdUp">
      {account ? (
        ...
        <Box component="button" width="100%" height="40px" color="white" backgroundColor="#56C5FF" padding="5px 14px" border="none" borderRadius={0.5} onClick={onPresentConnectModal} >
          Connect Wallet
        </Box>
      )}
    </MHidden>
