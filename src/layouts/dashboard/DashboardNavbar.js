            ...
            <Box style={{blurRadius:12, width:"90%", height:"100%"}}> 
              ...
              <Grid direction="row" container height="100%">
                <Grid item container xs={10} backgroundColor="#000000" height="100%">
                  <Box width="100%" padding="0 15px" position="relative">
                    <Box component="button" position="absolute" right="10px" top="10px" backgroundColor="rgb(255, 255, 255, 0)" onClick={mhandleClose}>
                      <Box component="img" src="my_public/images/closebutton.png"></Box></Box>
                    ...
                    <NavMenuItem onClick={handleClose} title="Blog" link="/blog" />
                    <NavMenuItem onClick={handleClose} title="Help Center" link="/helpcenter" />
                    <Box marginTop="50px" justifyContent="center" display="flex"><NetworkPopover /></Box>
                    <Box marginTop="10px" justifyContent="center" display="flex"><AccountPopover onClick={handleClose} /></Box>
                  </Box>
                </Grid>
              </Grid>
            </Box>
...
function NavMenuItem(props) {
  return (
    <>
    <MHidden width="mdDown">
      <Box component="a" color="white" padding="10px" style={{
        textDecoration:"none",
      }} href={props.link}>
        {props.title}
      </Box>
    ...
    <MHidden width="mdUp">
      <Grid item xs={12} marginTop="5px" display="flex" justifyContent="left" height="30px">
        <Box component="a" color="white" padding="2px" style={{
          textDecoration:"none",
        }} href={props.link}>
          {props.title}
        </Box>
