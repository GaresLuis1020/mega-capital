            ...
            <MHidden width="mdUp">
                <Grid paddingLeft={'5%'} paddingRight={'5%'} paddingTop="30px"  >
                    ...
                    <Grid container marginTop="30px" spacing={2} >
                        <Grid item xs="12"><AddressCard src="my_public/images/email.svg" title="Email" address="Info@megacapital.io"></AddressCard></Grid>
                        <Grid item xs="12"><AddressCard src="my_public/images/solana-sol-logo 1.png" title="Solana address" address="1231sdsxssds....124" token={1}></AddressCard></Grid>
                    </Grid>
    ...
    return(
        ...
        <Grid container direction="row" bgcolor={"#232323"} borderRadius={1} padding="15px" marginTop="20px">
            ...
            <Grid item md="2" alignItems="center" justifyContent="right" display="flex" paddingRight="15px">
                {props.angle === "down" ? <Box component="img" src="my_public/images/angle_down.png"/>
                : <Box component="img" src="my_public/images/angle_up.png"/>}
            </Grid>
        </Grid>
        </MHidden>
        <MHidden width="mdUp">
