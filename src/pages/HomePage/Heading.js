...
export default function Heading(){
  ...
  return(
      ...
      <Grid data-aos="zoom-out"  spacing={2} sx={{ paddingTop: '130px', marginBottom: '49px'}} position="relative" display="flex" >
        <Grid container sm={1.5} >
          ...
          {/* <Box component="a" marginBottom='5px' href={"https://discord.com/invite/zR2k28g3d9"} alignItems="center" sx={{width: 42, height: 42, borderRadius : "50%", backgroundImage: 'radial-gradient(rgb(35, 35, 35) 40%, white 15%, rgb(35, 35, 35)) 60%' }}> */}
            <Box component="a" target="_blank" marginBottom='10px' style={{boxShadow: "inset -1px -1px 3px rgba(224, 229, 230, 0.29)"}} href={"https://discord.gg/dzjkkBfxug"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#232323", borderRadius : "50%", padding : '10px'}}>
              <Box  component="img"  src={"my_public/images/github.png"}/>
            </Box>
            <Box component="a"  target="_blank" marginBottom='5px' style={{boxShadow: "inset -1px -1px 3px rgba(224, 229, 230, 0.29)"}} href={"https://twitter.com/Megacapitals"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#232323", borderRadius : "50%", padding : '10px' }} >
              <Box  component="img" src={"my_public/images/twitter (2).png"}/>
            </Box>
            <Box component="a"  target="_blank" marginBottom='10px' style={{boxShadow: "inset -1px -1px 3px rgba(224, 229, 230, 0.29)"}} href={"https://t.me/MegacapitalVC"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#232323", borderRadius : "50%", padding : '10px' }} >
              <Box  component="img" src={"my_public/images/paper-plane.png"}/>
            </Box>
            <Box component="a"  target="_blank" marginBottom='10px' style={{boxShadow: "inset -1px -1px 3px rgba(224, 229, 230, 0.29)"}} href={"https://medium.com/@megacapital.io"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#232323", borderRadius : "50%", padding : '10px' }} >
              <Box  component="img" src={"my_public/images/medium (2).png"}/>
            </Box>
            <Box component="a"  target="_blank" marginBottom='5px' style={{boxShadow: "inset -1px -1px 3px rgba(224, 229, 230, 0.29)"}} href={"https://megacapital-io.gitbook.io/megacapital.io"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#232323", borderRadius : "50%", padding : '10px' }} >
      ...
      <MHidden width="mdUp">
          <Grid  paddingLeft="13%" paddingRight="13%"><LaunchCard></LaunchCard></Grid>
          
          <Grid  paddingLeft="13%" paddingRight="13%" marginTop="20px" display="flex" justifyContent="center" >
            <h2 style={{fontSize:'28px', color:"white"}} className="mb-5 fw-bold">{t('MEGACAPITAL_IS')}<br></br> {t('AN_ALL_IN_ONE')}</h2>
          </Grid>
          <Grid paddingLeft="10%" paddingRight="10%" textAlign="center">
              <span style={{color:'#4EB4E2'}}>{t('Megacapital')}</span>&nbsp;<span style={{color:'white'}}>{t('is_a_decentralized')} </span>
              <span style={{color:'#4EB4E2'}}>&nbsp;{t('venture')}{t('capital')}</span><span style={{color:'white'}}> {t('community_based_with')} </span>
              <span style={{color:'#4EB4E2'}}>&nbsp;{t('all_in_')}{t('one_Multichain')} &amp; {t('Multi_Launchpad')}</span> <span style={{color:'white'}}>{t('investment_ecosystem_for')}&nbsp;</span>
              <span style={{color:'#4EB4E2'}}>{t('Metaverse')},{t('GamiFi')}&nbsp;</span><span  style={{color:'white'}}>{t('and')} </span> <span style={{color:'#4EB4E2'}}>{t('DEFI')}.</span>
          </Grid>
          
          <Grid marginTop="30px" spacing={2} paddingLeft="10%" marginBottom="90px">
            <Box component="button" href="/idodeals" borderRadius={1} backgroundColor="#56C5FF" color="white" padding="10px" border="none" fontSize={10}>BUY MEGA</Box>
            <Box component="button" href="/stakepad" borderRadius={1} backgroundColor="rgb(255, 255, 255, 0)" color="#56C5FF" border="1px solid #56C5FF" padding="10px" marginLeft="10px" fontSize={10}>STAKE MEGA</Box>
            <Box component="a" href="#"  style={{textDecoration:"none"}} marginLeft="10px" fontSize={10} color="white">JOIN THE COMMUNITY</Box>
          </Grid>
      </MHidden>
      </>
  );
