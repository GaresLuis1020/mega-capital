...
export default function Pools(){
    ...
    return(
        ...
        <MHidden width="mdUp">
        <Box data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0"  sx={{ marginTop: '50px', marginBottom: '50px', paddingLeft:'5%', paddingRight:'5%'}}>
            <Box sx={{ display: 'flex', justifyContent: 'center', p: 1, m: 1, borderRadius: 1,}}>
                <Box  component="img"  src={"my_public/images/h-4.png"}></Box>
            </Box>
            <Typography align='center'>
                ...
                <Box fontSize="16px" marginTop="80px" fontFamily={font_Family} style={{ marginBottom: '25px' }} color="white">Earn high yield by staking mega capital token  or join other attractive staking pools from IDO projects check word file please</Box>
            </Typography>
            <PoolsCardPhone allocation="0"/>
            <PoolsCardPhone allocation="0"/>
            <PoolsCardPhone allocation="0"/>
            <PoolsCardPhone allocation="1"/>
            <PoolsCardPhone allocation="1"/>
        </Box>
        </MHidden>
        </>
