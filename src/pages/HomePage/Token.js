...
export default function Token(){
    ...
    return(
        ...
        <Grid data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0"  container spacing={2} paddingLeft='14%' paddingRight='9%'>
          <Grid item sm={6}>
            ...
            <ul style={{ fontSize: '25px', color:'#56C5FF'}}>
              <li><span style={{color:"white"}}>Incubator</span></li>
              <li><span style={{color:"white"}}>Multi-Chain Networks</span></li>
              <li><span style={{color:"white"}}>IDO Launchpad</span></li>
              <li><span style={{color:"white"}}>Nft Launchpad</span></li>
              ...
              <li><span style={{color:"white"}}>Dao Goverance</span></li>
        ...
        <MHidden width="mdUp">
        <Box data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0"  sx={{ marginTop: '50px', marginBottom: '50px', paddingLeft:'3%', paddingRight:'3%'}}>
          <Box sx={{ display: 'flex', justifyContent: 'center', p: 1, m: 1, borderRadius: 1,}}>
            <Box  component="img"  src={"my_public/images/h-5.png"}></Box>
          </Box>
          <Typography align='center'>
            <Box data-aos="zoom-in" fontFamily={font_Family} sx={{display:'flex', position:'relative', justifyContent:'center'}}>
              <h2 style={{top:'13px',fontFamily:{font_Family}, color:"white"}}>Features & Token Utility</h2>
            </Box>
            <Box fontSize="12px" textTransform="capitalize" marginTop="20px" style={{ marginBottom: '25px', padding:"0 8%" }} color="white">The Megacapital token is developed on the BEP-20 Binance Smart Chain and will serve as the native token for the megacapital platform. Megacapital users will use this token for a variety of activities within our ecosystem as we will be mentioning some of them below;</Box>
          </Typography>
        </Box>
        <Grid  container spacing={2}>
          <Grid item xs={12} justifyContent="center" display="flex" color="white">Features</Grid>
          <Grid item xs={12} justifyContent="center" display="flex">
            <Box  component="img"  src={"my_public/images/border.png"} width='15%'></Box>
          </Grid>
          <Grid container item sm={12} direction="row">
            <Grid item xs={6}>
              <ul style={{ fontSize: 14, color:'#56C5FF'}}>
                <li><span style={{color:"white"}}>Indicator</span></li>
                <li><span style={{color:"white"}}>Multi-Chain Networks</span></li>
                <li><span style={{color:"white"}}>IDO Launchpad</span></li>
                <li><span style={{color:"white"}}>Nft pad</span></li>
                <li><span style={{color:"white"}}>VC Deals</span></li>
              </ul>
            </Grid>
            <Grid item xs={6}>
              <ul style={{ fontSize: 14, color:'#56C5FF'}}>
                <li><span style={{color:"white"}}>Yield Farming</span></li>
                <li><span style={{color:"white"}}>Dao Governance</span></li>
                <li><span style={{color:"white"}}>BUYBACK & BURN</span></li>
                <li><span style={{color:"white"}}>Mega insurance fund</span></li>
                <li><span style={{color:"white"}}>Stakepad</span></li>
              </ul>
            </Grid>
        ...
        {/* Token Distribution*/}
        <Grid container spacing={2} sx={{ marginTop: '20px', marginBottom: '20px', paddingLeft:'3%', paddingRight:'3%'}}>
          
          <Grid item xs={12} justifyContent="center" display="flex" color="white">Token Distribution</Grid>
          <Grid item xs={12} justifyContent="center" display="flex">
            <Box  component="img"  src={"my_public/images/border.png"} width='25%'></Box>
          </Grid>
          <Grid container item xs={12} direction="row">
              <Grid item xs={6}>
                <ul style={{ fontSize: '12px', color:'#56C5FF' }}>
                  <li><span style={{color:"white"}}>Seed sale 9%</span></li>
                  <li><span style={{color:"white"}}>Private sale 12%</span></li>
                  <li><span style={{color:"white"}}>Public sale 3%</span></li>
                  <li><span style={{color:"white"}}>Liquidity 5%</span></li>
                  <li><span style={{color:"white"}}>Team 14%</span></li>
                </ul>
              </Grid>
              <Grid item xs={6}>
                <ul style={{ fontSize: '12px', color:'#56C5FF' }}>
                  <li><span style={{color:"white"}}>Marketing 10%</span></li>
                  <li><span style={{color:"white"}}>Development 6%</span></li>
                  <li><span style={{color:"white"}}>Staking Rewards 25 %</span></li>
                  <li><span style={{color:"white"}}>Reserve 10%</span></li>
                  <li><span style={{color:"white"}}>Advisors 6%</span></li>
                </ul>
              </Grid>
        ...
        <Grid item xs={12}>
          ...
          <Box justifyContent="center" display="flex">
            <ul style={{ fontSize: '12px', marginTop: '20px', color:'#56C5FF' }}>
              ...
              <li><span style={{color:"white"}}>Dex Listing Price 0.006 BUSD</span></li>                  
              <li><span style={{color:"white"}}>TGE circulating supply: 7.4 % (including liquidity)</span></li>         
              <li><span style={{color:"white"}}>Net TGE circulating supply: 2.5%</span></li>                          
              <li><span style={{color:"white"}}>Tokens sold at TGE 24%</span></li>                  
              <li><span style={{color:"white"}}>Fully Diluted Market Cap $6,000,000</span></li>                  
              <li><span style={{color:"white"}}>TOTAL SUPPLY 1,000,000,000</span></li>                  
            </ul>
...
function MyChart1(props){
    ...
    return (
      <Box component="div" id="chart" ref={elementRef}  position="relative" >
        ...
        <Box position="absolute" top={ `calc(50% - ${props.width}px)`} left={ `calc(50% - ${props.width}px)`} style={{justifyContent: "center", alignContent:"center", display:"flex"}}>
            <Box component="img" src="my_public/images/circle_mega.png" width={props.width * 2} height={props.width * 2}></Box></Box>
