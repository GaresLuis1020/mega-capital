  ...
  return(
    ...
    <Grid container backgroundColor="#232323" padding="10px" marginBottom="20px" borderRadius={1}>
      <Grid item xs={12} height="100px" position="relative" display="flex">
        <Box component="img" width="100%" height="100%" position="absolute" src="my_public/images/projects (2).png"></Box>
        <Box component="img" src="my_public/images/logo.png" width="35px" height="30px" position="absolute" left="10px" top="10px"></Box>
        <Box backgroundColor="#232323" position="absolute" left="5px" bottom="5px" padding="1px 10px" color="white" borderRadius={0.5} fontSize={14}>NFT</Box>
        <Box component="button" backgroundColor="rgb(255, 255, 255, 0)" border="none" position="absolute" right="10px" top="10px">
          {props.angle === "down" ? <Box component="button" backgroundColor="rgb(255, 255, 255, 0)" border="none" onClick={() => window.scrollTo({ left: 0,top: 1300, behavior: "smooth", })}><Box component="img" src="my_public/images/angle_down.png"></Box></Box> :
          <Box component="img" src="my_public/images/angle_up.png"></Box>}
        </Box>
      </Grid>
      <Grid item xs={12} marginTop="15px" color="#56C5FF">Project Name</Grid>
      <Grid item xs={6} marginTop="15px" padding="5px"><Box component="button" borderRadius={0.5} width="100%" color="#56C5FF" backgroundColor="rgb(255, 255, 255, 0)" padding="5px" border="1px solid #56C5FF">NO</Box></Grid>
      <Grid item xs={6} marginTop="15px" padding="5px"><Box component="button" borderRadius={0.5} width="100%" color="white" backgroundColor="#56C5FF" padding="5px" border="none">YES</Box></Grid>
    </Grid>
...
function VoteCard(props){
    return(
            <Grid borderRadius={1} container bgcolor={'#232323'} direction="row" sx={{width:"100%"}} padding="20px 5px 20px 5px" marginTop="20px">
                <Grid item container md="5" sm="12" direction="row" >
                    <Box item component="img" src="my_public/images/logo.png" marginLeft="10px"></Box>
      ...
      <MHidden width="mdDown">
        <Grid container bgcolor={'#272727'} sx={{width:"100%"}} padding="20px"marginTop="20px" borderRadius={2}>
            ...
            <Grid container direction="row" marginBottom="20px">
                ...
                <Box component="button" marginLeft="10px" href="/" style={{height:"44px", border:"none", borderRadius:4, backgroundColor:"rgba(255, 255, 255, 0.1)", padding:"10px", color:"white"}}>
                    <Grid container direction="row" justifyContent="center" display="flex">
                    <Box component="img" marginTop="5px" width="20px" height="14px" src="my_public/images/File.png"></Box>
                    <Box marginLeft="5px" color="white">Pitch Dock</Box>
                  </Grid>
                </Box>
            </Grid>
            <Box component="img" borderRadius={2} width="100%" height="300px" src="my_public/images/projects (2).png"/>
        </Grid>
    </MHidden>
    <MHidden width="mdUp">
      <Grid container bgcolor={'#272727'} sx={{width:"100%"}} padding="20px" marginTop="20px" borderRadius={1}>
          <Grid item xs={12} justifyContent="center" display="flex"><Box component="p" fontSize={20} color="#56C5FF">About</Box></Grid>
          <Box marginTop="20px" component="p" textAlign="center" color="white" fontSize={12}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mattis congue volutpat in et, dui, iaculis. Commodo morbi posuere et porta. Velit aliquet imperdiet fringilla faucibus tincidunt quam facilisi. Risus, posuere lacus, vel aliquet ultrices sagittis, ultrices aenean rutrum. Scelerisque elementum porta enim egestas ac tempus eu. Lorem arcu vitae, id risus, faucibus duis sed. Sed egestas quis erat amet orci eu porttitor congue. Eu a at velit feugiat faucibus vitae enim. Cras massa sapien rhoncus natoque nec.Dolor habitant nisl vulputate morbi in ut ultrices dolor. Facilisis elementum est sed interdum amet in aenean sed. Enim porta proin donec sociis consectetur.</Box>
          <Grid container direction="row" marginBottom="20px">
              <Grid item xs={12}>
                <Box component="button" width="100%" href="/" style={{height:"44px", border:"none", borderRadius:4, backgroundColor:"rgba(255, 255, 255, 0.1)", padding:"10px 10px 10px 10px"}}>
                  <Grid container direction="row">
                    <Box component="img" marginTop="7px" width="26px" height="14px" src="my_public/images/homelink.png"/>
                    <Box marginLeft="5px" color="white">www.megacapital.com</Box>
                  </Grid>
                </Box>
              </Grid>
              <Grid item xs={12} marginTop="15px">
                <Box component="button" width="100%" href="/" style={{height:"44px", border:"none", borderRadius:4, backgroundColor:"rgba(255, 255, 255, 0.1)", padding:"10px", color:"white"}}>
                  <Grid container direction="row" justifyContent="center" display="flex">
                    <Box component="img" marginTop="5px" width="20px" height="14px" src="my_public/images/File.png"></Box>
                    <Box marginLeft="5px" color="white">Pitch Dock</Box>
                  </Grid>
              ...
              <Grid item xs={12} marginTop="28px" display="flex" justifyContent="space-around">
                <Box component="button" marginLeft="10px" href="/" style={{height:"44px", width:"44px", border:"none", borderRadius:4, backgroundColor:"rgba(255, 255, 255, 0.1)", padding:"10px"}}><Box component="img" src="my_public/images/plane_avatar.png"/></Box>
                <Box component="button" href="/" style={{height:"44px", width:"44px", border:"none", borderRadius:4, backgroundColor:"rgba(255, 255, 255, 0.1)", padding:"10px 10px 10px 10px"}}><Box component="img" src="my_public/images/twitter_avatar.png"/></Box>
                <Box component="button" marginLeft="10px" href="/" style={{height:"44px", width:"44px", border:"none", borderRadius:4, backgroundColor:"rgba(255, 255, 255, 0.1)", padding:"10px"}}><Box component="img" src="my_public/images/Discord.png"/></Box>
              </Grid>
          </Grid>
      </Grid>
    </MHidden>
